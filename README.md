...
cron_backup_hour=[Godzina, o której wykonywany jest skrypt do zarządzania backupami (w UTC)]
...
cron_backup_hour=[Hour of the day when the backup script is run (in UTC)]
